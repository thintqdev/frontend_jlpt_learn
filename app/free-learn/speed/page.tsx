...
export default function FreeLearnSpeedPage() {
  ...
  const checkAnswer = () => {
    ...
    const isCorrect =
      ...
      currentWord.meaning.toLowerCase().trim();
          ...
          <div className="px-6 pt-12 pb-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Bạn đã hoàn thành thử thách tốc độ
              </p>
            </div>
            ...
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-pink-100">
                  Trả lời nhanh nhất có thể trong 60 giây
                </p>
              </div>
            </div>
          ...
          <div className="px-6 py-8">
            <Card className="border-0 shadow-sm mb-6">
              <CardContent className="p-8 text-center">
                <div className="space-y-4">
                  <div className="text-5xl japanese-text font-bold text-gray-900">
                    {currentWord.word}
                  </div>
            ...
            <div className="mb-6">
              <input
                ...
                className="w-full p-4 text-xl text-center border-2 border-gray-200  focus:border-primary-500 focus:outline-none"
                autoFocus
              />
            </div>
            ...
            {streak > 0 && (
              <div className="mt-4 text-center">
                <Badge
                  variant="secondary"
                  className="bg-yellow-100 text-yellow-700 text-lg px-4 py-2"
                >
                  🔥 Streak: {streak}
                </Badge>
              </div>
