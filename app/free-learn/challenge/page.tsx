...
import { ArrowLeft, Trophy, Clock, Star, CheckCircle, XCircle, RotateCcw, Target } from "lucide-react"
...
export default function FreeLearnChallengePage() {
  ...
  const startChallenge = async (challenge: Challenge) => {
    ...
    try {
      const challengeLevel = challenge.difficulty === "Khó" ? level || 1 : undefined
      const fetchedWords = await JLPTApi.getRandomWords(challengeLevel, challenge.target + 5)
  ...
  const handleNextQuestion = () => {
    ...
    setTimeout(() => {
      if (currentIndex < words.length - 1 && newAnswers.length < selectedChallenge!.target) {
        ...
        <div className="bg-gray-50 min-h-screen">
          ...
          <div className="bg-gradient-to-br from-yellow-500 to-orange-600 text-white px-6 pt-12 pb-8">
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Thử thách hàng ngày</h1>
                  ...
                  <CardContent className="p-5">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-gray-900 mb-1">{challenge.title}</h4>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xs text-gray-500">• {formatTime(challenge.timeLimit)}</span>
                            <span className="text-xs text-primary-600 font-medium">+{challenge.points} điểm</span>
                          </div>
                        </div>
                      </div>
                      <Button
  ...
  if (gameFinished) {
    ...
    const earnedPoints = isSuccess ? selectedChallenge.points : Math.floor(selectedChallenge.points * 0.5)
        ...
        <div className="bg-gray-50 min-h-screen">
          <div className="px-6 pt-12 pb-8">
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-gray-900 mb-2">{isSuccess ? "Thành công!" : "Cố gắng thêm!"}</h1>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <Card className="border-0 shadow-sm">
                <CardContent className="p-4 text-center">
                  <div className="text-2xl font-bold text-primary-600 mb-1">{earnedPoints}</div>
            ...
            <div className="flex gap-3">
              <Button onClick={resetChallenge} variant="outline" className="flex-1 border-primary-200 text-primary-600">
      ...
      <AppLayout>
        <div className="flex items-center justify-center h-screen">
          <div className="text-center">
            <h1 className="text-xl font-bold text-gray-900 mb-4">Đang chuẩn bị thử thách...</h1>
          </div>
        </div>
      </AppLayout>
    )
    ...
    <AppLayout>
      <div className="bg-gray-50 min-h-screen">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 text-sm">
                ...
                <span className={`font-medium ${timeLeft < 30 ? "text-red-600" : "text-gray-700"}`}>
                  {formatTime(timeLeft)}
                </span>
              </div>
              <div className="flex items-center space-x-2 text-sm">
        ...
        <div className="px-6 py-8">
          ...
          >
            {currentIndex === selectedChallenge.target - 1 ? "Hoàn thành" : "Câu tiếp theo"}
          </Button>
        </div>
      </div>
    </AppLayout>
